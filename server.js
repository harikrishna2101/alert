...
async function checkExpiryDates(testDate = null) {
    ...
    for (const order of orders) {
        ...
        for (const item of order.items) {
            ...
            // Check if item expires in 2 days
                ...
                try {
                    ...
                    await transporter.sendMail({
                        ...
                        html: `
                            ...
                            <p>Dear Customer,</p>
                            <p>This is a reminder that the following item from your order will expire in 2 days:</p>
    ...
    try {
        await transporter.sendMail({
            ...
            html: `
                ...
                <p>You will receive a notification 2 days before any item is about to expire.</p>
                <br>
                <p>Best regards,<br>Grocery Expiration Alert Team</p>
            `
        });
